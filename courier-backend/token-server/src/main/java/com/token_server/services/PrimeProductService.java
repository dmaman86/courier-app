...
import com.token_server.repositories.PrimeProductRepository;
...
public class PrimeProductService {
    ...
    private PrimeProduct primeProduct;

    public void generatePrimeProduct(){
        ...
        primeProduct = createPrimeProduct(p, q);
        primeProductRepository.save(primeProduct);
    }

    public PrimeProduct getPrimeProduct(){
        return primeProduct;
    }
    ...
    private PrimeProduct createPrimeProduct(BigInteger p, BigInteger q) {
        BigInteger n = p.multiply(q);
        BigInteger phi = p.subtract(BigInteger.ONE).multiply(q.subtract(BigInteger.ONE));
        return PrimeProduct.builder()
                .product(n.toString())
